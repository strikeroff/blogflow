...
class HTML5libSanitize
  ...
  include HTML5
  HTML5::HTMLSanitizeModule::ALLOWED_ELEMENTS.concat(["object", "param", "embed"])
  HTML5::HTMLSanitizeModule::ALLOWED_CSS_PROPERTIES.concat(["background"])


  HTML5::HTMLSanitizeModule.module_eval do
  ...
  def sanitize_html(html, options = {})
    ...
    if @encoding == 'utf-8'
      parsed = HTMLParser.parse_fragment(html.to_s.to_utf8, {:tokenizer => HTMLSanitizer,
              :encoding => @encoding, :tree => @treebuilder })
    else
